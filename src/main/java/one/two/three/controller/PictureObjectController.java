...
public class PictureObjectController {
	...
	public String removePicture(@RequestParam("pictureId") int pic_id, @RequestParam("productId") int productId, Model model) {
	...
	public String adminRemovePicture(@RequestParam("pictureId") int pic_id, @RequestParam("prodId") int prodId, Model model) {
